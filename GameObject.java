...
//        String[] li = this.aos[index].split(" ");
//        Ponto dpos = null;
//        double d = 0;
//        int dl = 0;
//        if(li[0].compareTo("move") == 0){
//            dpos = new Ponto(Double.parseDouble(li[1]), Double.parseDouble(li[2]));
//            dl = Integer.parseInt(li[3]);
//        }else d = Double.parseDouble(li[1]);
//        this.fig = this.t.applyTransformations(li[0], dpos, d, dl);
//    }
